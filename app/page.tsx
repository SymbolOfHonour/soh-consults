...
const links = [
  ...
  { label: "Guides", href: "/guides" }, { label: "LASU Calculator", href: "/lasu-calculator" },
  { label: "FUOYE Calculator", href: "/fuoye-calculator" },
...
const shortcuts = [
  ...
  { label: "LASU Aggregate Calculator", href: "/lasu-calculator", icon: "▦" },
  { label: "FUOYE Screening Calculator", href: "/fuoye-calculator", icon: "▦" },
  { label: "CGPA Simulator", href: "/cgpa-calculator", icon: "▥" },
    ...
    <main className="min-h-screen bg-[#faf8f2] text-[#102720]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#043b29] via-[#06452f] to-[#07583b] text-white">
        ...
        <div className="relative mx-auto grid max-w-[1440px] items-center gap-5 px-4 pt-8 sm:px-7 lg:grid-cols-[1.05fr_1fr_.85fr] lg:gap-4 lg:px-10 lg:pt-10">
          <div className="relative z-10 lg:pb-10"><p className="mb-3 text-xs font-bold uppercase tracking-[.18em] text-[#e6f0e9]">Admissions • Education • Consultation</p><h1 className="text-4xl font-black leading-[1.08] sm:text-5xl xl:text-6xl">Your Guide.<br /><span className="text-[#efc46e]">Your Success.</span></h1><p className="mt-4 max-w-lg text-sm leading-6 text-[#f2f5ef] sm:text-base">Trusted admission support, educational opportunities and professional guidance for a brighter future.</p><div className="mt-6 flex flex-wrap gap-2"><a href="/opportunities" className="rounded-xl bg-[#efc46e] px-4 py-3 text-sm font-extrabold text-[#102720] hover:bg-[#ffdb8e]">Explore Opportunities →</a><a href="/lasu-calculator" className="rounded-xl border border-white px-4 py-3 text-sm font-bold text-white hover:bg-white/10">LASU Calculator →</a><a href="/fuoye-calculator" className="rounded-xl border border-white px-4 py-3 text-sm font-bold text-white hover:bg-white/10">FUOYE Calculator →</a><a href={contact("Hello S.O.H CONSULTS, I need admission guidance.")} target="_blank" rel="noopener noreferrer" className="rounded-xl border border-white/60 px-4 py-3 text-sm font-bold text-white hover:bg-white/10">Chat with Us</a></div><div className="mt-7 grid max-w-md grid-cols-3 gap-2 border-t border-white/20 pt-4"><div><strong className="text-xl">4+</strong><p className="text-xs text-[#dcece3]">Years of Service</p></div><div><strong className="text-xl">24/7</strong><p className="text-xs text-[#dcece3]">Online Updates</p></div><div><strong className="text-xl">1:1</strong><p className="text-xs text-[#dcece3]">Personal Guidance</p></div></div></div>
