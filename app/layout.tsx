...
import CalculatorDisclaimerNotice from "./components/CalculatorDisclaimerNotice";
...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}><head><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9913781873857877" crossOrigin="anonymous"/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(organizationStructuredData)}}/></head><body className="min-h-full flex flex-col"><PWARegister/><HomeAnnouncement/>{children}<CalculatorDisclaimerNotice/><footer aria-label="Legal information" className="bg-[#043b29] px-4 py-3 text-center text-xs text-white"><a href="/privacy-policy" className="inline-block rounded px-2 py-1 font-semibold underline underline-offset-4 hover:text-[#efc46e] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#efc46e]">Privacy Policy</a><a href="/disclaimer" className="inline-block rounded px-2 py-1 font-semibold underline underline-offset-4 hover:text-[#efc46e] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#efc46e]">Disclaimer</a><span className="block pt-1">CAC Registered Business | BN8780171</span></footer><HomeLatestUpdates/><VisitCounter/><BusinessAnalytics/><AskSOH/><InstallApp/></body></html>;
}
